...
admin.initializeApp();
exports.getIngredients = functions.https.onRequest((request, response) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getasdf = functions.https.onRequest((request, response) => __awaiter(void 0, void 0, void 0, function* () {
    cors(request, response, () => __awaiter(void 0, void 0, void 0, function* () {
        const number = request.query.number;
        let itemRes = yield fetchData(number);
        //let img = await fetchDataPic(number);
